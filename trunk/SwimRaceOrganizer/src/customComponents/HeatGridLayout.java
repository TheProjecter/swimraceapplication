...
public class HeatGridLayout extends GridLayout {
	public HeatGridLayout() {
		this(1, 0, 0, 0);
	}

	public HeatGridLayout(int rows, int cols) {
		this(rows, cols, 0, 0);
	}

	public HeatGridLayout(int rows, int cols, int hgap, int vgap) {
