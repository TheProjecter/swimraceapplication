...
public class AllRegistrations extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		setTitle(resourceMap.getString("AllRegistrations.title")); // NOI18N
		...
		jTAllRegistrations.getColumnModel().getColumn(0).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title0")); // NOI18N
		jTAllRegistrations.getColumnModel().getColumn(1).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title1")); // NOI18N
		jTAllRegistrations.getColumnModel().getColumn(2).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title2")); // NOI18N
		jTAllRegistrations.getColumnModel().getColumn(3).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title3")); // NOI18N
		jTAllRegistrations.getColumnModel().getColumn(4).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title4")); // NOI18N
		jTAllRegistrations.getColumnModel().getColumn(5).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title5")); // NOI18N
		jTAllRegistrations.getColumnModel().getColumn(6).setHeaderValue(
				resourceMap.getString("jTAllRegistrations.columnModel.title6")); // NOI18N
		...
		jLRegToDelete.setText(resourceMap.getString("jLRegToDelete.text")); // NOI18N
