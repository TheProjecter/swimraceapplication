...
public class AllSwimmers extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		setTitle(resourceMap.getString("AllSwimmers.title")); // NOI18N
		...
		jTAllSwimmers.getColumnModel().getColumn(0).setHeaderValue(
				resourceMap.getString("jTAllSwimmers.columnModel.title0")); // NOI18N
		jTAllSwimmers.getColumnModel().getColumn(1).setHeaderValue(
				resourceMap.getString("jTAllSwimmers.columnModel.title1")); // NOI18N
		jTAllSwimmers.getColumnModel().getColumn(2).setHeaderValue(
				resourceMap.getString("jTAllSwimmers.columnModel.title2")); // NOI18N
		jTAllSwimmers.getColumnModel().getColumn(3).setHeaderValue(
				resourceMap.getString("jTAllSwimmers.columnModel.title3")); // NOI18N
		jTAllSwimmers.getColumnModel().getColumn(4).setHeaderValue(
				resourceMap.getString("jTAllSwimmers.columnModel.title4")); // NOI18N

		jLSwimmerToDelete.setText(resourceMap
				.getString("jLSwimmerToDelete.text")); // NOI18N
