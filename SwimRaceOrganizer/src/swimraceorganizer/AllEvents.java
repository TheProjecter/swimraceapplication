...
public class AllEvents extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		setTitle(resourceMap.getString("AllEvents.title")); // NOI18N
		...
		jTAllEvents.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "Event Name", "Distance", "Stype", "Gender",
						"Pool Type" }));
		jTAllEvents.setName("jTAllEvents"); // NOI18N
		jScrollPane1.setViewportView(jTAllEvents);
		jTAllEvents.getColumnModel().getColumn(0).setHeaderValue(
				resourceMap.getString("jTAllEvents.columnModel.title0")); // NOI18N
		jTAllEvents.getColumnModel().getColumn(1).setHeaderValue(
				resourceMap.getString("jTAllEvents.columnModel.title1")); // NOI18N
		jTAllEvents.getColumnModel().getColumn(2).setHeaderValue(
				resourceMap.getString("jTAllEvents.columnModel.title2")); // NOI18N
		jTAllEvents.getColumnModel().getColumn(3).setHeaderValue(
				resourceMap.getString("jTAllEvents.columnModel.title3")); // NOI18N
		jTAllEvents.getColumnModel().getColumn(4).setHeaderValue(
				resourceMap.getString("jTAllEvents.columnModel.title4")); // NOI18N
		...
		jLEventToDelete.setText(resourceMap.getString("jLEventToDelete.text")); // NOI18N
